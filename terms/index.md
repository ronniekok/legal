...
- **Application** means the software program provided by the Company downloaded by You on any electronic device, named Kanjify.
...
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to Kanjify.
...
- By email: [kanjifysupport@gmail.com](mailto:kanjifysupport@gmail.com)
